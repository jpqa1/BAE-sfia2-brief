...
echo "- name: install Docker
  ...
  - name: Install docker-compose
    ...
    get_url: 
      ...
      mode: 'u+x,g+x'" > ./ansible/roles/docker/tasks/main.yml
...
echo "- name: Install Jenkins
  ...
  tasks:
    ...
    - name: Print init password Jenkins
      debug:
        var: result.stdout" > ./ansible/roles/jenkins/tasks/main.yml
...
- name: 'install the nginx.conf file on to the remote machine'
  ...
  notify: 'reload nginx'" > ./ansible/roles/nginx/tasks/main.yml
